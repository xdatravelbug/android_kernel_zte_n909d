...
static bool printk_time = 0;  //chenjg delete for print too long
#else
...
bool printk_cpuid = 0;  //chenjg delete for print too long
#else
bool printk_cpuid = 0;
#endif
	...
	for (; *p; p++) {
		if (new_text_line) {
			...
			if (printk_rtc) {
				...
				tlen = sprintf(tbuf, "[(%d-%02d-%02d %02d:%02d:%02d.%03d)] ",
						tm.tm_year + 1900, tm.tm_mon + 1, tm.tm_mday,
						tm.tm_hour, tm.tm_min, tm.tm_sec, (int)ts.tv_nsec/1000000); //chenjg change for print too long
